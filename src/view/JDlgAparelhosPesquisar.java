...
ControllerAparelhos controllerAparelhos;
     ...
     */
    public JDlgAparelhosPesquisar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgAparelhosPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgAparelhosPesquisar dialog = new JDlgAparelhosPesquisar(new javax.swing.JFrame(), true);
