 ...
 * @author Marcos
 */
public class JDlgConsultaAparelhos extends javax.swing.JDialog {
  ControllerConsultasAparelhos controllerConsultasAparelhos;
    /**
     * Creates new form JDlgMscUsuariosPesquisar
     */
 
    public JDlgConsultaAparelhos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTxtMarca, javax.swing.GroupLayout.PREFERRED_SIZE, 261, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        ...
        AparelhosDao aparelhosDAO = new AparelhosDao();
        List lista;
        if ((jTxtMarca.getText().isEmpty() == false) && (jTxtValor.getText().isEmpty() == false)){
            lista = (List) aparelhosDAO.listMarcaValor(jTxtMarca.getText(), Util.strToDouble(jTxtValor.getText()));
        }else if (jTxtMarca.getText().isEmpty() == false){
            lista  = (List) aparelhosDAO.listMarca(jTxtMarca.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgConsultaAparelhos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgConsultaAparelhos dialog = new JDlgConsultaAparelhos(new javax.swing.JFrame(), true);
